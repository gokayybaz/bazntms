-- 0019_audit_v2 (SQLite) — bkz. postgres/0019_audit_v2.sql.
-- Faz 25-C: denetim kaydı v2. Mevcut satırlarda hepsi boş → append-only
-- hash zinciri BOZULMAZ (auditHash v2 segmentini yalnız bir alan doluyken
-- ekler). Yeni satırlarda actor_type + result her zaman dolu → tamper-evident.
