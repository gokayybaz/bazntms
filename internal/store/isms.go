...
var annexAControls = []IsmsSoaItem{
	...
	{ControlID: "A.5.14", Category: "A.5", Title: "Bilgi aktarımı", Evidence: "Agent↔hub mTLS + protobuf-over-HTTPS; delil paketi imzalı dışa aktarım"},
	...
	{ControlID: "A.8.5", Category: "A.8", Title: "Güvenli kimlik doğrulama", Evidence: "mTLS agent bağlantısı + bcrypt şifre + OIDC"},
	...
	{ControlID: "A.8.24", Category: "A.8", Title: "Kriptografi kullanımı", Evidence: "AES-GCM vault, ed25519 imza, RFC 3161 TSA, mTLS; vault.key yönetimi"},
