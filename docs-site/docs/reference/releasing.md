---
title: Sürüm Çıkarma (Release)
sidebar_position: 14
custom_edit_url: https://github.com/gokayybaz/bazntms/edit/main/docs/RELEASE-RUNBOOK.md
---

> Kaynak: [`docs/RELEASE-RUNBOOK.md`](https://github.com/gokayybaz/bazntms/blob/main/docs/RELEASE-RUNBOOK.md) — bu sayfa her build'de otomatik senkronize edilir.
