...
title: Mimari
sidebar_position: 12
custom_edit_url: https://github.com/gokayybaz/bazntms/edit/main/docs/ARCHITECTURE.md
---

> Kaynak: [`docs/ARCHITECTURE.md`](https://github.com/gokayybaz/bazntms/blob/main/docs/ARCHITECTURE.md) — bu sayfa her build'de otomatik senkronize edilir.
# Mimari
