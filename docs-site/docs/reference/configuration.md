...
title: Yapılandırma
sidebar_position: 11
custom_edit_url: https://github.com/gokayybaz/bazntms/edit/main/docs/CONFIGURATION.md
---

> Kaynak: [`docs/CONFIGURATION.md`](https://github.com/gokayybaz/bazntms/blob/main/docs/CONFIGURATION.md) — bu sayfa her build'de otomatik senkronize edilir.
